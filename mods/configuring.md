 ...
 * `info` - Описание в свободной форме того, куда/кому следует сообщать о проблемах

 * `url` - URL-адрес сервера Discord, репозитория GitHub и т. д., где сообщается о проблемах

### `dependencies`

Зависимости мода; подробности см. в [Зависимости](/mods/dependencies.md)


### `settings`

Настройки мода; подробности см. в [Settings](/mods/settings.md)


### `resources`

Ресурсы мода; подробности см. в [Resources](/mods/resources.md)
...
Массив, определяющий список заголовков, которые должны быть включены в этот мод. Поддерживает [globbing](/mods/resources.md).
...
| `cheats` | Мод добавляет читы, такие как noclip |
...
| `joke` | Мод является шуточным. Смотрите [документацию](/mods/guidelines#joke-mods), какие шуточные моды считаются "значимыми" |
