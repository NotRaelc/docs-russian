...
Зависимости мода; подробности см. в [ависимостях](/mods/dependencies.md)

### `incompatibilities`

Несовместимости мода. Очень похоже на [dependencies](/mods/dependencies.md), однако допустимыми значениями являются `breaking`, `conflicting` и `upersed`.
